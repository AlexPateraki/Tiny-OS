...
/** 
  ...
  This is a struct that contains thread.
  Each process has multible PTCBs in order to be multithreaded.
*/
...
/**
  @brief Deletes the given PTCB and removes its node from the list; returns 0 on success, -1 on failure 
*/
int delete_PTCB(PTCB* ptcb);
